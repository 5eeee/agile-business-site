...
I18N.ru = {
    ...
    hero_subtitle:'Три направления экспертизы — бизнес-аналитика, ИТ и креатив — для роста и цифровизации вашего бизнеса',
    ...
    srv_label:'Экспертиза', srv_title_1:'Три направления', srv_title_2:'для вашего роста',
    srv_desc:'Бизнес-аналитика, ИТ и разработка, креатив — команды с глубокой экспертизой и проверенной методологией',
    srv_1_title:'Бизнес-аналитика',
    srv_1_desc:'Анализ рынка и конкурентов, воронка продаж, KPI, процессы, финансы, юнит-экономика, бизнес-планы и GTM — по ценнику Agile Business',
    srv_2_title:'ИТ и Разработка',
    srv_2_desc:'IT-аудит и стратегия, веб- и мобильная разработка, SaaS, интеграции, данные, AI и информационная безопасность',
    srv_3_title:'Креатив',
    srv_3_desc:'Три поднаправления: маркетинг, продажи и дизайн — позиционирование, performance, контент, воронка, скрипты, айдентика и UI/UX',
    price_strip_label:'Прайс',
    price_strip_title_1:'Наши услуги',
    price_strip_title_2:'ориентиры по стоимости',
    price_strip_note:'Ориентиры для категории «средний бизнес» по внутренним ценникам; итоговая смета — после брифа.',
    ...
    page_desc:'Бизнес-аналитика, ИТ и креатив — консалтинг и реализация с прозрачными ориентирами по стоимости.',
    page_desc_calc:'Рассчитайте ориентировочную стоимость: бизнес-аналитика, ИТ и креатив.',
    currency_symbol:'₽',
...
I18N.en = {
    ...
    hero_subtitle:'Three focus areas — business analytics, IT and creative — to grow and digitize your business',
    ...
    about_stat_1_label:'focus\nareas', about_stat_2_label:'successful\nprojects', about_stat_3_label:'clients\nrecommend',
    ...
    srv_label:'Expertise', srv_title_1:'Three directions', srv_title_2:'for your growth',
    srv_desc:'Business analytics, IT & development, and creative — teams with deep expertise and proven methodology',
    srv_1_title:'Business analytics',
    srv_1_desc:'Market & competitor analysis, sales funnel, KPIs, processes, finance, unit economics, business plans and go-to-market',
    srv_2_title:'IT & Development',
    srv_2_desc:'IT audit & strategy, web & mobile, SaaS, integrations, data, AI and information security',
    srv_3_title:'Creative',
    srv_3_desc:'Marketing, sales and design — positioning, performance, content, funnel, scripts, identity and UI/UX',
    price_strip_label:'Pricing',
    price_strip_title_1:'Our services',
    price_strip_title_2:'reference prices',
    price_strip_note:'Mid-market reference points from our rate cards; final quote after a brief.',
    srv_flip_tab:'Focus',
    ...
    page_desc:'Business analytics, IT and creative — consulting and delivery with clear pricing references.',
    page_desc_calc:'Estimate your project: business analytics, IT and creative.',
    currency_symbol:'\u20bd',
