...
const SERVICE_KEYWORDS = {
    ...
    analytics: {
        ...
        keywords: ['аналитика','данные','data','bi','дашборд','dashboard','sql','python','excel','метрика','kpi','прогноз','модель','визуализация','etl','big data','ml','machine learning','power bi','tableau','риск','отчёт','статистика','анализ','мониторинг','olap','хранилище','сегментация','a/b тест','когорта','data-driven','воронка','конкурент','cjm','юнит-экономика','ltv','cac','бизнес-процесс','bpmn','go-to-market','gtm'],
        context: 'Опишите задачу: аналитика процессов, рынка, финансов, воронки, KPI или отчётность — что нужно на выходе',
        tg_emoji: '📊'
    },
    it: {
...
const DEFAULT_CALCULATOR_PRICING = require('./data/default-calculator-pricing.json');
function getDefaultPricing() {
    return JSON.parse(JSON.stringify(DEFAULT_CALCULATOR_PRICING));
}
